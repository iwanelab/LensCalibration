...
**StepA. 独立マッチング** — ダッシュカムの各フレームに近い撮影位置の参照画像を選び、ALIKED / LightGlueで見た目だけを頼りに対応点を探す。ここでは標準設定ではなく、**解像度を上げ、検出感度を上げ、検出数の上限も外したALIKED設定**を使い、路面の特徴点が建物に埋もれず拾えるようにしている。
